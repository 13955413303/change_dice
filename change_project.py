...
fishpond_stg_changelist = {
    'ws': '		"endpoint": "wss://agent.stg.lain.leyanbot.com/ws",\n',
    'authority":': '		"authority": "https://stg-api.leyanbot.com/dice/v1",\n',
    'anneau":': '		"anneau": "http://staging-anneau.infra.leyantech.com",\n',
    'endpoint": "http://': '				"endpoint": "https://stg-api.leyanbot.com/dice/v1"\n'
}
...
p0 = Radiobutton(root, text=project_map[0][0], variable=v_project, value=0,command=lambda:project_choose(project_map[0][0],project_map[0][1])).grid(row=0, column=0 + 1)
p1 = Radiobutton(root, text=project_map[1][0], variable=v_project, value=1,command=lambda:project_choose(project_map[1][0],project_map[1][1])).grid(row=0, column=1 + 1)
p2 = Radiobutton(root, text=project_map[2][0], variable=v_project, value=2,command=lambda:project_choose(project_map[2][0],project_map[2][1])).grid(row=0, column=2 + 1)
